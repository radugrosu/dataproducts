...
These datasets were downloaded manually, and then cleaned and consolidated in [R](https://www.r-project.org/).
...
One of two contrasts can be chosen for both plots: differences due to Gender, and differences due to Socio-economic status (Educational attainment `ISCED 5/6` group vs. `ISCED 0/1/2` group <sup>[2](http://www.uis.unesco.org/Education/Documents/isced-2011-en.pdf)</sup>).
...
The information regarding the dataset and the OECD was introduced mostly verbatim from http://www.oecdbetterlifeindex.org.

The visualization was inpired by [this](http://ramnathv.github.io/rChartsShiny/) post by Ramnath Vaidyanathan.